    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <h3 class="font-weight-semi-bold mb-4">${{ $PetsDetail->price }}</h3>
                <div class="d-flex mb-3">
                    <strong class="text-dark mr-3">Breed: {{ $PetsDetail->breed }}</strong>
                </div>
                <div class="d-flex mb-3">
                    <strong class="text-dark mr-3">Status: {{ $PetsDetail->status }}</strong>
                </div>
                {{-- <div class="d-flex mb-3">
                ...
                @foreach ($pets as $pet)
                    <div class="product-item bg-light">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">{{ $pet->name }}</a>

    ...
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="<?php echo e(asset('Admin/img/' . $ProductsDetail->image)); ?>"
                            alt="Image">
                    </div>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                <h3><?php echo e($ProductsDetail->name); ?></h3>
                ...
                <h3 class="font-weight-semi-bold mb-4">$<?php echo e($ProductsDetail->price); ?></h3>
                <div class="d-flex mb-3">
                    <strong class="text-dark mr-3">Status: <?php echo e($ProductsDetail->status); ?></strong>
                </div>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <button class="btn btn-primary px-3" id="add-to-cart-button-product" data-product-id="<?php echo e($ProductsDetail->product_id); ?>">
            ...
            <div class="bg-light p-30">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab-pane-1">
                        ...
                        <p><?php echo e($ProductsDetail->description); ?>
...
<?php /**PATH D:\GraduationThesis_PetE-commerce_G5\resources\views/Front_end/Contents/shopdetailproducts.blade.php ENDPATH**/ ?>
        ...
        <div class="container-fluid px-4">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" value ="<?php echo e($cate->name); ?>" placeholder="Name Proudct ...">
                </div>
                <div class="mb-3">
                ...
                <a href="<?php echo e(asset('Admins/Pets/manageproducts')); ?>" class="btn btn-warning">Back</a>
...
<!-- JS -->
<?php echo $__env->make('Admins.Layouts.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\GraduationThesis_PetE-commerce_G5\resources\views/Admins/Contents/editproducts.blade.php ENDPATH**/ ?>
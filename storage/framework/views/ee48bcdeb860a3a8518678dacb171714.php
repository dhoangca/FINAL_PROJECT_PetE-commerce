                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">   
                            ...
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('Clients.postRegisterU')); ?>" class="user">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="text-center">
                                <a class="small" href="<?php echo e(route('Clients.Login')); ?>">Already have an account? Login!</a>
                            </div>
                            <br>
                        </div>
                    </div>
...
<?php /**PATH D:\GraduationThesis_PetE-commerce_G5\resources\views/Auth/registeru.blade.php ENDPATH**/ ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="<?php echo e(asset('/')); ?>" class="text-decoration-none">
    ...
    <!-- Topbar End -->
<?php /**PATH D:\GraduationThesis_PetE-commerce_G5\resources\views/Front_end/Layouts/topbar.blade.php ENDPATH**/ ?>
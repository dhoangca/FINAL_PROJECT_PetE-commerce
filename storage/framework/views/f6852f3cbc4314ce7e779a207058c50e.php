    ...
    <div class="container-fluid">
                    ...
                    <div class="btn-group">
                        <?php if(auth()->guard()->guest()): ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="<?php echo e(route('Clients.Login')); ?>" class="text-decoration-none"><button
                                        class="dropdown-item" type="button"> Sign in </button></a>
                                <a href="<?php echo e(route('Clients.Register')); ?>" class="text-decoration-none"><button
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="<?php echo e(asset('Clients')); ?>" class="text-decoration-none">
            ...
            <div class="col-lg-4 col-6 text-left">
                <form role="search" method="get"  action="<?php echo e(asset('Clients/Contents/search/')); ?>">
    ...
    <!-- Topbar End -->
<?php /**PATH D:\Xampp\htdocs\GraduationThesis_PetE-commerce_G5\resources\views/Front_end/Layouts/topbar.blade.php ENDPATH**/ ?>
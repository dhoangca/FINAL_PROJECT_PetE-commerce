        ...
        <div class="col-lg-9 col-md-8">
            <div class="row pb-3">
                ...
                <?php elseif(!$petResults->isEmpty()): ?>
                    <?php $__currentLoopData = $petResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4" data-price="<?php echo e($pet->price); ?>">
                    ...
                    <?php if($petResults->hasPages()): ?>
                        <div class="col-12">
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">

                                    
                                    <?php if($petResults->onFirstPage()): ?>
                                        <li class="page-item disabled"><a class="page-link" href="#">Previous</a>
                                        </li>
                                    <?php else: ?>
                                        <li class="page-item"><a class="page-link"
                                                href="<?php echo e($petResults->previousPageUrl()); ?>&query=<?php echo e($query); ?>">Previous</a>
                                        </li>
                                    <?php endif; ?>

                                    
                                    <?php for($i = 1; $i <= $petResults->lastPage(); $i++): ?>
                                        <li class="page-item <?php echo e($i == $petResults->currentPage() ? 'active' : ''); ?>">
                                            <a class="page-link"
                                                href="<?php echo e($petResults->url($i)); ?>&query=<?php echo e($query); ?>"><?php echo e($i); ?></a>
                                        </li>
                                    <?php endfor; ?>

                                    
                                    <?php if($petResults->hasMorePages()): ?>
                                        <li class="page-item"><a class="page-link"
                                                href="<?php echo e($petResults->nextPageUrl()); ?>&query=<?php echo e($query); ?>">Next</a>
                                        </li>
                                    <?php else: ?>
                ...
                <?php elseif(!$productResults->isEmpty()): ?>
                    ...
                    <?php if($productResults->hasPages()): ?>
                        <div class="col-12">
                            <nav aria-label="Page navigation">
                                <ul class="pagination justify-content-center">

                                    
                                    <?php if($productResults->onFirstPage()): ?>
                                        <li class="page-item disabled"><a class="page-link" href="#">Previous</a>
                                        </li>
                                    <?php else: ?>
                                        <li class="page-item"><a class="page-link"
                                                href="<?php echo e($productResults->previousPageUrl()); ?>&query=<?php echo e($query); ?>">Previous</a>
                                        </li>
                                    <?php endif; ?>

                                    
                                    <?php for($i = 1; $i <= $productResults->lastPage(); $i++): ?>
                                        <li
                                            class="page-item <?php echo e($i == $productResults->currentPage() ? 'active' : ''); ?>">
                                            <a class="page-link"
                                                href="<?php echo e($productResults->url($i)); ?>&query=<?php echo e($query); ?>"><?php echo e($i); ?></a>
                                        </li>
                                    <?php endfor; ?>

                                    
                                    <?php if($productResults->hasMorePages()): ?>
                                        <li class="page-item"><a class="page-link"
                                                href="<?php echo e($productResults->nextPageUrl()); ?>&query=<?php echo e($query); ?>">Next</a>
                                        </li>
                                    <?php else: ?>
...
<?php /**PATH D:\GraduationThesis_PetE-commerce_G5\resources\views/Front_end/Contents/search.blade.php ENDPATH**/ ?>
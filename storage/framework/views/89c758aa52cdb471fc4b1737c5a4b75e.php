                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    <a href="<?php echo e(asset('Clients/Contents/checkout')); ?>"
                                        class="dropdown-item <?php echo e(request()->is('Clients/Contents/checkout') ? 'active' : ''); ?>">Chó Alaska
                                        Malamute</a>
                                    <a href="<?php echo e(asset('Clients/Contents/checkout')); ?>"
                                        class="dropdown-item <?php echo e(request()->is('Clients/Contents/checkout') ? 'active' : ''); ?>">Chó
                                        Beagle</a>
                                    <a href="<?php echo e(asset('Clients/Contents/checkout')); ?>"
                                        class="dropdown-item <?php echo e(request()->is('Clients/Contents/checkout') ? 'active' : ''); ?>">Chó
                                        Corgi</a>
                                    ...
                                    <hr>
                                    <a href="<?php echo e(asset('Clients/Contents/checkout')); ?>"
                                        class="dropdown-item <?php echo e(request()->is('Clients/Contents/checkout') ? 'active' : ''); ?>">Mèo
                                        Anh
                                        (Dài + Ngắn)</a>
                                    <a href="<?php echo e(asset('Clients/Contents/checkout')); ?>"
                                        class="dropdown-item <?php echo e(request()->is('Clients/Contents/checkout') ? 'active' : ''); ?>">Mèo
    ...
    <!-- Navbar End -->
<?php /**PATH D:\FINAL_PROJECT_PetE-commerce\resources\views/Front_end/Layouts/navbar.blade.php ENDPATH**/ ?>
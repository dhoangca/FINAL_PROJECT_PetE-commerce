                    ...
                    <div class="product-item bg-light mb-4">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                ...
                                <a class="btn btn-outline-dark btn-square" href="<?php echo e(asset('Clients/Contents/shopdetailpet/' . $value['pet_id'])); ?>"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                ...
                                <small class="fa fa-star text-primary mr-1"></small>
                                <small class="fa fa-star text-primary mr-1"></small>
                                <small>(<?php echo e($value['sales']); ?>)</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            ...
                            <a class="btn btn-outline-dark btn-square"
                                href="<?php echo e(asset('Clients/Contents/shopdetailpet/' . $value->pet_id)); ?>"><i
                ...
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            ...
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
                            <a class="btn btn-outline-dark btn-square"
                                href="<?php echo e(asset('Clients/Contents/shopdetailproducts/' . $value->product_id)); ?>"><i
                                    class="fa fa-search"></i></a>
                        </div>
                    </div>
                    <div class="text-center py-4">
...
<?php /**PATH D:\GraduationThesis_PetE-commerce_G5\resources\views/Front_end/Contents/index.blade.php ENDPATH**/ ?>